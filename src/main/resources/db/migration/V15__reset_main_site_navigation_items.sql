truncate table site_navigation_item restart identity;
...
cross join (
    values
        ('about', '교회 소개', '/about', '/about', 'INTERNAL', null, true, true, true, true, true, 10),
        ('sermons', '예배 영상', '/sermons', '/sermons', 'INTERNAL', null, true, true, true, true, true, 20),
        ('newcomer', '제자 양육', '/newcomer', '/newcomer', 'INTERNAL', null, true, true, true, true, true, 30)
) as data(
    menu_key,
    label,
    href,
